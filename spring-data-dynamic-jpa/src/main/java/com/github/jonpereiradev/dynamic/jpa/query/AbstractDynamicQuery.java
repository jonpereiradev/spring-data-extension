...
abstract class AbstractDynamicQuery implements DynamicQuery {
    ...
    @Override
    public final Object getObject(String name, Object defaultValue) {
        return isPresent(name) ? parameters.getFirst(name) : defaultValue;
    }

    @Override
    public final List<Object> getObjects(String name) {
    ...
    @Override
    public final LocalDate getLocalDate(String name) {
        return getLocalDate(name, null);
    }

    @Override
    public final LocalDate getLocalDate(String name, LocalDate defaultValue) {
        return isPresent(name) ? DynamicQueryMatchers.toLocalDate(parameters.getFirst(name)) : defaultValue;
    }

    @Override
    public final LocalDateTime getLocalDateTime(String name) {
        return getLocalDateTime(name, null);
    }

    @Override
    public final LocalDateTime getLocalDateTime(String name, LocalDateTime defaultValue) {
    ...
    public final boolean isPresent(String name) {
        return parameters.containsKey(name)
            ...
            && StringUtils.isNotBlank(DynamicQueryMatchers.toString(parameters.getFirst(name)));
    }
    ...
    public final Sort getSort() {
        ...
        object.stream().filter(o -> o != null && isNotBlank(o.toString())).forEach(o -> {
